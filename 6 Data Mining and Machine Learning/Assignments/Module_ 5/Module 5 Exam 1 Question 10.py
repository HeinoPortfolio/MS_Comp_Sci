# -*- coding: utf-8 -*-
"""
Created on Sun May 18 05:07:32 2025
...
def distance_avg_meth(C1, C2):
    
    distance = 0
    
    for p in C1:
        for q in C2:
            distance = distance + manhattan_distance(p, q)
...
# Verify the avg method is working -------------------------------------------

C1 = [[8,9],[4,6]]
C2 = [[7,5],[5,2]]

print("\n\nAverage Method result: ", distance_avg_meth(C1, C2))
...
print(distance_avg_meth(cluster_p, cluster_q ))


# Distance between Cluster P and Cluster R ----------------------------------- 
print("\nDistance between Cluster P and Cluster R is: \n")
print(distance_avg_meth(cluster_p, cluster_r))


# Distance between Cluster P and Cluster Q ----------------------------------- 
print("\nDistance between Cluster Q and Cluster R is: \n")
print(distance_avg_meth(cluster_q , cluster_r))
