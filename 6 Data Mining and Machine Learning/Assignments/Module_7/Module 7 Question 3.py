...
# Question 3:
#
# When K = 3, what is the prediction accuracy of the test data? 
#

# Create the KNN classifier ---------------------------------------------------

knn_classifier_1 = KNeighborsClassifier(n_neighbors=5)
...
print("\nThe accuracy of the model with K=5 was: ", accuracy)
