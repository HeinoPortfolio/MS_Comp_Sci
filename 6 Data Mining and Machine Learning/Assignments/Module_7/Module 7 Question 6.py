...
# Question 6:
#
# When K = 11, what is the prediction accuracy of the test data? 
#

# Create the KNN classifier ---------------------------------------------------

knn_classifier_1 = KNeighborsClassifier(n_neighbors=11)
...
print("\nThe accuracy of the model with K=11 was: ", accuracy)
