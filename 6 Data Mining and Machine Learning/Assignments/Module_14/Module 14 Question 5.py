...
mlp_clf = MLPClassifier(activation='logistic', max_iter=10000, random_state=42)
...
accuracy_score_lr = mlp_clf.score(X_test, y_test)

# Print the results of the model ----------------------------------------------

print("\nQuestion 5: \n\nUsing 'logistic', the accuracy of the model was: ",
      accuracy_score_lr)
