...
test_data_points = pd.read_csv("cs654_homework9_test_10.csv", 
                               header=None).values.tolist()

test_data_labels = pd.read_csv("cs654_homework9_test_10_labels.csv", 
                               header=None).values.tolist()
...
#
# Use dataset 3 and dataset 4 to test the classifier. 
#
...
print("\nQuestions 3: \nThe accuracy of the model was: (using score())",
      accuracy_lr)
