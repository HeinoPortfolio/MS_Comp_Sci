...
test_data = pd.read_csv("cs654_homework8_test_10.csv",
                            header=None).values.tolist()

# Read in the test data labels ------------------------------------------------

test_data_labels = pd.read_csv("cs654_homework8_test_10_labels.csv",
                               header=None).values.tolist()
...
# Question 1:
#
# Use dataset 1 and dataset 2 to construct a regular scikit learn decision tree
# with random_state = 42, and gini criterion.
#
# Use dataset 3 and dataset 4 to test the tree's performance. 
#
...
print("Question 1: The results of model using 'gini' and random_state (42) were: ",
      accuracy)
