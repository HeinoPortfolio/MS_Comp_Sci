...
# Question 7:
#
# Use dataset 1 to train a scikit learn Logistic Regression classifier. Test 
# the constructed classifier on dataset 2.
#
# What is the accuracy?
#

# Make a prediction using the data in dataset 2 -- the test data --------------
predicted_labels = lr_clf.predict(X_test) 
...
accuracy_score = lr_clf.score(X_test, Y_test)
