...
# Question 8
#
# For the wrong negative predictions (true label is negative, but prediction 
# is positive),
# 
...
print("\n\nQuestion 8: \n")
print("\nThe average score for both a negative label and positive prediction is: \n",
      score_col_avg)

print("\n\nThe average score for both a negative label and positive prediction is [rounded]: \n",
