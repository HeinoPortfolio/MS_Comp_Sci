...
# positive), 
# 
# How many scores are less than or equal to 0.7?
#

pos_pos_pred_df = reviews_df[(reviews_df['label'] == 1) &
                             (reviews_df['Predicted_Reviews_Enc'] == 1) &
                             (reviews_df['Predicted_Reviews_Scores'] <= 0.7)]

# Compute the average of the score column -------------------------------------

num_scores_70 = len(pos_pos_pred_df)

print("\n\nQuestion 6: \n")
print("\nThe number of scores that are greater than or equal to 0.7 is [x >= 0.7]:\n",
      num_scores_70)
