...
- $`\textcolor{blue}{\text{R programming language}}`$
- $`\textcolor{blue}{\text{R markdown }}`$
- $`\textcolor{blue}{\text{Data wrangling}}`$
- $`\textcolor{blue}{\text{GitHub}}`$
- $`\textcolor{blue}{\text{Data visualization}}`$
- $`\textcolor{blue}{\text{Data representation}}`$
