...
```{r read_data_files, results= FALSE}
...
```{r sp_unemp, fig.cap= "A spatial map over the contiguous USA for the unemployment rate for the year 2014", fig.height=7, fig.width=10}
...
```{r sp_crime, fig.cap="Spatial map over the contiguous USA for the crime rate for the year 2014", fig.height=7, fig.width=10}
...
```{r scatter_un_cr, fig.cap="Scatter plot for the data relationship between the unemployment rate and crime rate", fig.height=7, fig.width=10}
...
```{r unemployment_rate, fig.cap= "Unemployment rate time series plot."}
...
```{r crime_rate, fig.cap= "Crime rate time series plot."}
