...
* Step 3: Remove the state variable from the data frame.
* Step 4: Create the color vectors.
* Step 5: Create the RangeGroup column.
* Step 6: Create the first histogram based on the crime rate and the year and utilize the first color vector.
* Step 7: Create the second histogram based on the crime rate and the RangeGroup and utilize the second color vector.
...
### 4) Create a new column for the Range Group
...
This histogram displays a ranged group based on   
