...
-- 2) List Name, Continent, and Region for all countries whose 
-- Surface Area is more than or equal to 1,000,000
...
-- 4) List country Names and their Capital (name) for all countries in 
...
-- 6) List all fields for counties whose Government form is Federal Republic
SELECT * 
FROM country
...
-- 8) List Names of countries whose Language is German
SELECT co.Name 
FROM country co
...
-- 12) List Names of all cities in the State (field name in the table is District) of 
