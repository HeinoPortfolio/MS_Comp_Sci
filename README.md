...
2 |[Discrete Structures](https://github.com/HeinoPortfolio/MS_Comp_Sci/tree/main/2%20Discrete%20Structures) | Core | ???? |$`\textcolor{red}{\text{Need}}`$
...
6 | [Data Mining and Machine Learning](https://github.com/HeinoPortfolio/MS_Comp_Sci/tree/main/6%20Data%20Mining%20and%20Machine%20Learning) |Elective | Discussed data mining algorithms, implementations, systems, and applications. Topics included data preprocessing, data clustering, data classification, mining association rules, and anomaly detection. Implementation of data mining algorithms. Data mining applications on real data in various domains.  | $`\textcolor{green}{\text{In Progress}}`$
