...
9 | [Software Engineering]() | Core |  Software engineering principles and concepts. The software life cycle, structured specifications, design tools and techniques, software reliability, and verifying program correctness.  |  $`\textcolor{red}{\text{Need}}`$
